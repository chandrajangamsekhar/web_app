...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :customers, 'Customers', customers_path, highlights_on: %r(/customers), class: 'menu-item'

    # Add an item which has a sub navigation (same params, but with block)
    # primary.item :admin, 'Admin', '/', if: -> { current_user.present? && current_user.admin? } do |sub_nav|
    #   # Add an item to the sub navigation (same params again)
    #   sub_nav.item :users, 'Users', users_path #, if: -> { current_user.present? && current_user.admin? }
    # end
